...
// getMetric обрабатывает входной запрос на получение значения метрики по её идентификатору.
...
// getMetricJSON обрабатывает входной запрос на получение метрики по её идентификатору в формате JSON.
